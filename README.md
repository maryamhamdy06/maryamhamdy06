...
🧠 Distributed LLM Inference System	Load-balanced serving system for LLM inference	Python, Flask, Ollama, ngrok
🕹️ Grid Clash	Custom game protocol & server built from scratch	C, Linux, UDP
🧩 Jigsaw Puzzle Image Processing Pipeline	Automated puzzle-solving pipeline using classical CV	Python, OpenCV, NumPy, SciPy
💬 Reddit Clone	Full-stack social platform built with a 6-person team	Node.js, React, MongoDB
🍄 Mushroom Classification & Data Mining	Comparative ML classification & data mining study	Python, R, Random Forest, CatBoost
